...
response.setContentType("text/html");
		...
		for(AddEmpDetails e:list) {
			...
			out.print("<tr><td>"+e.getId()+"</td><td>"+e.getName()+"</td><td>"+e.getPassword()+"</td><td>"+e.getEmail()+"</td><td>"+e.getAddress()+"</td><td>"+e.getCity()+"</td><td>"+e.getCountry()+"</td><td><a href='UpdateDetailsSer?id="+e.getId()+"'> Edit </a></td> <td><a href='DeleteDetails?id="+e.getId()+"'>Delete</a></td><tr>");
